...
namespace Illuminate\Support\Facades { 
    ...
    class DB {
        ...
        {
            return \Vinelab\NeoEloquent\Connection::getSsl();
        }
        ...
        {
            return \Vinelab\NeoEloquent\Connection::getConfig($option);
        }
         ...
         * @static 
         */ 
        public static function select($query, $bindings = array(), $useReadPdo = false)
        {
            return \Vinelab\NeoEloquent\Connection::select($query, $bindings, $useReadPdo);
        }
         ...
         * @param string $query
         * @param array $bindings
         * @return \Vinelab\NeoEloquent\CypherQuery 
         * @static 
         */ 
        ...
        {
            \Vinelab\NeoEloquent\Connection::rollBack($toLevel);
        }
        ...
        {
            return \Vinelab\NeoEloquent\Connection::lastInsertedId();
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Vinelab\NeoEloquent\Connection::selectOne($query, $bindings, $useReadPdo);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            \Vinelab\NeoEloquent\Connection::bindValues($statement, $bindings);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            \Vinelab\NeoEloquent\Connection::recordsHaveBeenModified($value);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            \Vinelab\NeoEloquent\Connection::resolverFor($driver, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Vinelab\NeoEloquent\Connection::getResolver($driver);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Vinelab\NeoEloquent\Connection::transaction($callback, $attempts);
        }
